<div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
    <div class="flex text-gray-500">
      ...
      <select wire:model="userRoleFilter" wire:change="reloadTable()">
      ...
      <button type="button" 
                    class="mt-3 inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-gray-50 text-base font-medium text-gray-700 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" 
      ...
      <td class="px-6 py-4">
        ...
        <td class="px-6 py-4">
          <div class="flex justify-end gap-4">
            <a x-data="{ tooltip: 'Edite' }" href="#" wire:click="showEditModal({{$user->id}})">
              <svg
            ...
            <!-- Delete button -->
            <div class="flex justify-end gap-4 text-red-600 hover:text-red-900">
            <a x-data="{ tooltip: 'Delete' }" href="#" onclick="borrarUsuario({{$user}})">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <script>
      function borrarUsuario(user){
        ...
        if (confirm('¿Estas seguro de eliminar este usuario?')){
          Livewire.dispatch('deleteUser', {user:user});
        }
      }
